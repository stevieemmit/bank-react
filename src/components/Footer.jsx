...
const Footer = () => (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
        ...
        <div className='flex-1 flex flex-col justify-start mr-10'>
            <img src={logo} alt="goobank" className='w-[266px] h-[72px] object-contain' />
            <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>A new way make payments easy, relaible and secure</p>
        </div>
