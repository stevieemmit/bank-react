...
const Billing = () => (
    <section id='product' className={layout.sectionReverse}>
        ...
        <div className={layout.sectionInfo}>
            ...
            Easily contol your <br className='sm:block hidden' /> billing & invoicing</h2>
            <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
                Elit enim sed massa etiam. Marius eu adipiscing ultrices amaetidio aeanma neque. Fusce ipsum 
                orci thonus aliporttitor integar placeta palcerat.
            </p>

            <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
                <img src={apple} alt="spple_store" className='w-[128px] h-[42px] object-contain mr-5 cursor-pointer' />
